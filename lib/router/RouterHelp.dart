...
class RouterHelp {
  ...
  RouterHelp._(this._context, this._routeName);

  static RouterHelp build(BuildContext context, String name) {
    return RouterHelp._(context, name);
  }

  RouterHelp withParam(String key, Object value) {
    params[key] = value;
    return this;
  }
